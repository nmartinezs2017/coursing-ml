...
class UdacitySpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for card in cards:
            ...
            yield response.follow(absolute_next_page_url, self.parse_card, cb_kwargs=dict(difficulty=difficulty, school=school, skills=skills, is_free=is_free, collaboration=collaboration, n_reviews=n_reviews, active_stars=active_stars))

    def parse_card(self, response, difficulty, school, skills, collaboration, n_reviews, active_stars, is_free):
