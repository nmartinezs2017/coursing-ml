...
class CourseraSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for page in range(1, 180, 1): # 180 is the number of pages in this directory
            url = 'https://www.coursera.org/directory/courses?page=' + str(page)
            yield response.follow(url, self.parse_directory)

        for page in range(1, 18, 1): # 18 is the number of pages in this directory
    ...
    def parse_page(self, response):
        ...
        if section == 'projects':
            ...
            rating = sel.xpath('//*[@class="_16ni8zai m-b-0 rating-text number-rating m-l-1s m-r-1"]/text()').extract_first()
